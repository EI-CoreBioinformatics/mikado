...
"""
This module defines a holder of Monosublocus instances. It is the last step before the definition of real
loci.
"""
...
class MonosublocusHolder(Sublocus, Abstractlocus):
    ...
    def add_transcript_to_locus(self, transcript, check_in_locus=True):
        ...
        :param check_in_locus: optional flag to pass to the basic method. If set to False it disables
        checks on whether the transcript is really in the locus
    ...
    def __str__(self, print_cds=False):
        ...
        raise NotImplementedError(
            "This is a container used for computational purposes only, it should not be printed out directly!")
    ...
    def define_loci(self, purge=False, excluded=None):
        ...
        :param purge: flag. If set to True, all loci whose transcripts have scores of 0 will be thrown out
    ...
    def is_intersecting(cls, transcript, other, cds_only=False):
        ...
        - Otherwise, check for any CDS overlap.
         ...
         :param cds_only: boolean flag. If set to True, only the CDS component of the transcripts will be considered to
         determine whether they are intersecting or not.
         :type cds_only: bool
        ...
        if cls.overlap((transcript.start, transcript.end),
