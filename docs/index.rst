...
Our tool was presented at `Genome Science 2016 <http://genomescience.org.uk/>`_, both as a :download:`poster <assets/Mikado_GenomeScience2016_poster.pdf>` and in :download:`a talk during the Bioinformatics showcase session <assets/Mikado_GenomeScience2016.pdf>`. A preprint is currently available on bioRxiv, and the manuscript has been submitted for peer review.
...
Luca Venturini, Shabhonam Caim, Gemy Kaithakottil, Daniel Lee Mapleson, David Swarbreck: "Leveraging multiple transcriptome assembly methods for improved gene structure annotation", bioRxiv 216994; doi: https://doi.org/10.1101/216994
