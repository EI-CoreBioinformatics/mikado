...
"""
Comparison script to examine the concordance of a prediction file with a reference annotation.
It has been equally inspired by ParsEval (for e.g. measures of concordance) and cuffcompare
(e.g. class codes).
"""
