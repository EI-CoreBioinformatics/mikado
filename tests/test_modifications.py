from Mikado import utilities, exceptions
from Mikado.parsers.GFF import GffLine
from Mikado.loci import Transcript
from Mikado.loci.locus import Locus, expand_transcript
...
class TestPadding(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.fai = pkg_resources.resource_filename("tests", "chr5.fas.gz")
    ...
    def test_basic_padding(self):
        ...
        template.finalize()
        fai = pysam.FastaFile(pkg_resources.resource_filename("tests", "chr5.fas.gz"))
