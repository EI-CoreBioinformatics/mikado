...
#         self.assertAlmostEqual( result.n_recall[0],  100*(300-200+1 + 1000-500+1+1800-1500+1)/reference.cdna_length, delta=0.1)
    ...
    def test_mono_intronic(self):
        ...
        if result.j_f1[0]>0:
            self.assertAlmostEqual( result.j_f1[0], 2*(result.j_recall[0]*result.j_prec[0])/(result.j_prec[0]+result.j_recall[0]), delta=0.1  )
    ...
    def test_multi_intronic(self):
        ...
        self.assertEqual(result.j_recall, (0,))
        if result.j_f1[0]>0:
            self.assertAlmostEqual( result.j_f1, 2*(result.j_recall[0]*result.j_prec[0])/(result.j_prec[0]+result.j_recall[0]), delta=0.1  )
        self.assertEqual( result.n_prec,  (0,))
        self.assertEqual( result.n_recall,  (0,))
