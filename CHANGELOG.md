...
- Two new operators are available for the requirements: **"is"** and **"is not"**. They allow to perform boolean checks (eg, has the transcript a suspicious splicing pattern?)
