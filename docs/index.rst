...
Mikado was published in GigaScience in August 2018. Development is currently active, and we are working for integrating it in a `dedicated annotation pipeline <https://github.com/lucventurini/ei-annotation/>`.
